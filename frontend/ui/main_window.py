...
class MainWindow(QMainWindow):
    def __init__(self, bridge: EngineBridge):
        ...
        self.setWindowTitle("ARGUS - Observe Everything")
    ...
    def build_pages(self, bridge):
        ...
        self.stack.addWidget(OverviewPage(bridge=bridge))

        self.stack.addWidget(ProcessesPage(bridge=bridge))

        self.stack.addWidget(SystemPage(bridge=bridge))

        self.stack.addWidget(PerformancePage(bridge=bridge))

        self.stack.addWidget(MemoryPage(bridge=bridge))

        self.stack.addWidget(DiskPage(bridge=bridge))

        self.stack.addWidget(NetworkPage(bridge=bridge))

        self.stack.addWidget(RecordingPage(bridge=bridge))

        self.stack.addWidget(SettingsPage(bridge=bridge))

        self.stack.addWidget(AboutPage(bridge=bridge))
